 ...
 * @return mixed
 */
function skeleton_remove_query_string_version($src)
{
...
if (!is_admin()) {
    ...
    add_filter('style_loader_src', 'skeleton_remove_query_string_version', 9999);

    // Remove Wp version from scripts
    add_filter('script_loader_src', 'skeleton_remove_query_string_version', 9999);
}
/*
|--------------------------------------------------------------------------
| Custom Login Error Message
...
function skeleton_custom_login_error_message()
{
    return __('Oops! Incorrect input', 'skeleton');
}

add_filter('login_errors', 'skeleton_custom_login_error_message');

 ...
 * @param $template
 */
function skeleton_maintenance($maintenance, $template)
{
    $skeleton_maintenance = function () use ($template) {
    ...
    switch ($maintenance) {
        case 'full':
            add_action('init', $skeleton_maintenance);
            break;
        case 'enable':
            if (!current_user_can('administrator')) {
                // Frontend
                add_filter('template_include', $skeleton_maintenance);

                // REST API
                add_action('rest_api_init', $skeleton_maintenance);
            }
            break;
    }
}
